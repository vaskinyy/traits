...
HITCHHIKERS_THUMBS_MAP = dict(
    STRAIGHT=['CC', 'Cc'],
    MODERATEHITCHHIKERS=['cc'],
)
...
NAMES = {
    ...
    'HITCHHIKERS_THUMBS': (HITCHHIKERS_THUMBS_MAP, None),
    'CURLY_HAIR': (CURLY_HAIR_MAP, None),

    'BITTER_TASTE': (BITTER_TASTE_MAP, BITTER_TASTE_PROBS), #threshold
